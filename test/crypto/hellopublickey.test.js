...
it('should be equal', function (done) {
    ...
    },
    {
        ...
        privateKey: '980e04a80a3d1880f57bc1557b7eadf4575973e8df57d9b34b61f393d22779d6',
        path: '0/0/1',
        index: 1,
    ...
    let xpub = storage[3].xpub;

    app.encrypt({ externalkeyWithDerive: xpub }, data, APP.Crypto.HELLOPUBLICKEY)
        .then((encryptedData) => {
