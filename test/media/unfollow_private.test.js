...
it('should create new media, follow and then unfollow', function (done) {
    ...
    app.on('addMediaDialog', (localkey, mediaName, callback) => {
        dialogsWithMedia[mediaName] = localkey;
    ...
    app.on('follower', (mediaData, followerkey) => {
        ...
        app.unfollow('followtest')
    })


    app.on('notfollower', (mediaData, followerKey) => {

        //console.log('not follower', mediaData, followerKey, dialogsWithMedia['followtest'].localkey)
        assert(followerKey == dialogsWithMedia['followtest'].localkey);
        done();
    })
