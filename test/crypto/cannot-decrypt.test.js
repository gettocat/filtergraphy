...
it('should be equal', function (done) {
    ...
    app.encrypt({ localkey: storage[0].publicKey, externalkey: storage[1].publicKey }, data, APP.Crypto.FILTERFROMFILTERTO)
        .then((encryptedData) => {
            console.log('encrypted:', encryptedData.toString('hex'));

            app.removeDialog(storage[1].publicKey, storage[0].publicKey);
